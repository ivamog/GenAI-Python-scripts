# This repository contains some useful python scripts that use Gemini API to generate your PDF files summary or simply ginerate prompt and receive API response.
#
